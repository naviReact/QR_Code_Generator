  ...
  return (
    <div className="container">
      <h2
        ...
        style={{ marginRight: "16.50rem", marginTop: "0.78rem" }}
      >
        WiFi QR Code Generator
      </h2>
      <label htmlFor="ssid">SSID (Network Name):</label>
      <input
        className="input_box_wifi"
        type="text"
        id="ssid"
      ...
      <div className="password-input">
        <input
          ...
          style={{
            ...
            height: "50px",
            borderRadius: "8px",
            padding: "13.106px 12.006px 13.096px 11.996px",
          ...
          <div className="accordion-content">
            ...
            <div className="grid-container">
              <div className="box-child">
                <img src={cancel_image}></img>
              </div>
              <div className="box-child">
                <img src={image}></img>
              </div>
              <div className="box-child">
                <img src={Youtube_Image}></img>
              </div>
              <div className="box-child">
                <img src={Email_Image}></img>
              </div>
              <div className="box-child">
                <img src={location_Image}></img>
              </div>
              <div className="box-child">
                <img src={whatsapp_Image}></img>
              </div>
              <div className="box-child">
                <img src={wifi_Image}></img>
              </div>
              <div className="box-child">
                <img src={Insta_Image}></img>
              </div>
            </div>
            <div></div>
      ...
      <button onClick={generateWifiQRCode} className="generate_qr">
        <i
